...
export default function AutoTuner() {
  ...
  async function handleStartJob() {
    ...
    try {
      ...
      toast.success('Tuning job started');
      loadData();

      // Trigger worker
      await supabase.functions.invoke('tuning-worker', {
  ...
  async function handleContinueJob(jobId: string) {
    try {
      toast.info('Continuing tuning job...');
      const { error } = await supabase.functions.invoke('tuning-worker', {
        body: { job_id: jobId },
      });
      if (error) throw error;
      toast.success('Tuning job continued');
      loadData();
    } catch (error) {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="terminal-card p-6 space-y-6">
                ...
                <div className="pt-4 border-t border-border">
                  <h4 className="font-medium mb-4">Objective Weights</h4>
                  <div className="space-y-4">
                    <div>
              ...
              <div className="terminal-card p-6 space-y-4">
                ...
                <Button
                  ...
                  disabled={starting || !selectedVersion || !selectedDataset}
                  ...
                  <tbody>
                    {jobs.map((job) => (
                      ...
                      >
                        ...
                        <td>{job.trials_completed} / {job.max_trials}</td>
